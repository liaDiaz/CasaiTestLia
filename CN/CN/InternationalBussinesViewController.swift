//
//  InternationalBussinesViewController.swift
//  CN
//
...
class InternationalBussinesViewController: UIViewController ,UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCell(withIdentifier: "myCellIntenationalBussines", for: indexPath)
        
        if(cell == nil){
            cell=UITableViewCell(style: UITableViewCell.CellStyle.subtitle, reuseIdentifier: "myCellIntenationalBussines")
        }
